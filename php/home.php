                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="processing-hero-text wow move-up">
                            ...
                            <div class="hero-button mt-30">
                                <a href="https://www.figma.com/proto/Tq6Cx6PFpg3JTgIBhcEKGz/Fluance-Design?node-id=10043%3A1212&scaling=min-zoom" class="btn btn--white">Essayer</a>
                                <div class="hero-popup-video video-popup">
                                    <a href="https://youtu.be/AE1H_ztPEBw" class="video-link">
                                        <div class="video-content">
                                            ...
                                            <div class="video-text"> Comment ça fonctionne</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="processing-hero-images-wrap wow move-up">
                            <div class="processing-hero-images">
                                <img class="img-fluid" src="<?php echo DOMAIN_THEME_IMG.'proto.png'?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
